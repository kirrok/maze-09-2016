...
public class ClientSnapshotsService {
    ...
    private final Map<Id<User>, List<ClientSnap>> snaps = new HashMap<>();
    ...
    public void pushClientSnap(@NotNull Id<User> user, @NotNull ClientSnap snap) {
    ...
    @NotNull
    public List<ClientSnap> getSnapForUser(@NotNull Id<User> user) {
